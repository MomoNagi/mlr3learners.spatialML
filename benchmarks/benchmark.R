...
# Preparation de California Housing
...
# Définition des learners
grf_bw <- 20
grf_ntree <- 50

# Definition des learners de base
...
# Validation croisée à 5 divisions
...
# Configuration batchtools pour SLURM
...
# Extraction des mesures de performance
